            ...
            <div class="card card-purple card-outline shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ $formAction }}" id="feeDefinitionForm">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="syear" id="syear" class="form-control select2 @error('syear') is-invalid @enderror" required>
                                @for ($y = date('Y') - 2; $y <= date('Y') + 5; $y++)
                                    ...
                                    <option value="{{ $yearFormatted }}"
                                        {{ old('syear', $isEditing ? $feeDefinition->syear : Qs::getCurrentSchoolYear()) == $yearFormatted ? 'selected' : '' }}>
                                        {{ $yearFormatted }}
                                    </option>
                                @endfor
                            </select>
                        ...
                        {{-- Total Amount --}}
                        <div class="form-group mb-3">
                            <label for="total_amount" class="form-label">Total Amount ({{ Qs::getCurrencySymbol() }}) <span class="text-danger">*</span></label>
