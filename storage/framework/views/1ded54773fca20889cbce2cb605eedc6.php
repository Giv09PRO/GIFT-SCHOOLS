...
<meta property="og:image" content="<?php echo e($absoluteSchoolLogoUrl ?? asset('favicon.svg')); ?>">
...
<meta name="twitter:image" content="<?php echo e($absoluteSchoolLogoUrl ?? asset('favicon.svg')); ?>">
    ...
    <div id="wrapper">
        <div id="header_div">
            <nav class="navbar-static-top">
                <div id="header_logo">
                    <img src="<?php echo e($schoolLogoUrl); ?>" alt="<?php echo e($logoAltText); ?>">
                </div>
        ...
        <div class="container top-bar-info">
            <div class="row">
                <div class="col-md-6 col-sm-6">Academic Year: <?php echo e($academicYear); ?></div>
                <div class="col-md-6 col-sm-6 text-right"><?php echo e($currentDate); ?></div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5 order-1 order-md-2">
                    <div id="login-box">
                        ...
                        <form action="<?php echo e($loginUrl); ?>" method="post" class="form-horizontal">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="login"><?php echo e(__('Email or Username')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('login')); ?>" placeholder="Enter your username or email" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-submit">
                                    <i class="fas fa-sign-in-alt mr-1"></i> <?php echo e(__('adminlte::adminlte.sign_in')); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-left mb-2 mb-md-0">
                    <strong>&copy; <?php echo e(date('Y')); ?> <a href="https://gift-schools.sc.tz" target="_blank">Gift Schools</a>.</strong> All rights reserved.<br>
...
<?php /**PATH /home/giftscho/school-system/resources/views/auth/login.blade.php ENDPATH**/ ?>