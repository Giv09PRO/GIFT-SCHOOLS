                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Student::class)): ?>
                                <a href="<?php echo e(route('staff.grades.unassigned')); ?>" class="btn btn-warning btn-sm">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\GradeLevel::class)): ?>
                                <a href="<?php echo e(route('staff.grades.create')); ?>" class="btn btn-primary btn-sm ml-2"> 
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Tool\Datatable::resolve(['id' => 'gradesTable','heads' => $heads,'config' => $config,'striped' => true,'hoverable' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/giftscho/school-system/resources/views/pages/staff/grades/index.blade.php ENDPATH**/ ?>