                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Parents::class)): ?>
                                <a href="<?php echo e(route('staff.manage.parents.create')); ?>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-plus mr-1"></i> Add New Parent
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Tool\Datatable::resolve(['id' => 'parentsTable','heads' => $heads,'config' => $config,'striped' => true,'hoverable' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/giftscho/school-system/resources/views/pages/staff/parent/index.blade.php ENDPATH**/ ?>