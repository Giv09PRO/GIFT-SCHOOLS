...
<?php $__env->startSection('title', 'Manage Fee Installments'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        ...
        <a href="<?php echo e(route('staff.fees.definitions.index')); ?>" class="btn btn-sm btn-secondary me-2">
            <i class="fas fa-cogs me-1"></i> Manage Fee Definitions
        </a>
        
        <a href="<?php echo e(route('staff.fees.structure.assign_create')); ?>" class="btn btn-sm btn-info me-2">
            <i class="fas fa-sitemap me-1"></i> Assign Fee Structure
        </a>
        <a href="<?php echo e(route('staff.fees.assign_bulk.form')); ?>" class="btn btn-sm btn-success me-2">
            <i class="fas fa-users me-1"></i> Assign Single Fee (Bulk)
        </a>
        <a href="<?php echo e(route('staff.fees.create')); ?>"
        ...
        <a href="<?php echo e(route('staff.payments.allocate_unlinked.form')); ?>" class="btn btn-sm btn-warning">
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('staff.fees.index')); ?>" id="filterForm">
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="student_search" id="student_search"
                                   ...
                                   value="<?php echo e(request('student_search')); ?>" placeholder="Enter name or ID (e.g. P001)">
                        </div>
                        <div class="col-md-4">
                            <label for="title" class="form-label">Installment Title</label>
                            <input type="text" name="title" id="title" class="form-control form-control-sm"
                                   value="<?php echo e(request('title')); ?>" placeholder="e.g., Term 1 Fees">
                        </div>
                        <div class="col-md-4">
                            <label for="invoice_no" class="form-label">Invoice Number</label>
                            <input type="text" name="invoice_no" id="invoice_no" class="form-control form-control-sm"
                                   value="<?php echo e(request('invoice_no')); ?>" placeholder="Enter invoice number">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="payment_status" id="payment_status"
                                ...
                                <?php $__currentLoopData = $paymentStatuses ?? ['' => 'All Payment Statuses', 'paid' => 'Balance Zero (Paid/Waived)', 'unpaid' => 'Outstanding Balance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                        value="<?php echo e($value); ?>" <?php echo e(request('payment_status') == $value ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" id="status" class="form-control form-control-sm select2">
                                <?php $__currentLoopData = $feeStatuses ?? ['' => 'All Fee Statuses', 'active' => 'Active (Outstanding)', 'waived' => 'Any Waiver Applied', 'fully_waived' => 'Fully Waived (Balance Zero)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            ...
                            <a href="<?php echo e(route('staff.fees.index')); ?>" class="btn btn-secondary btn-sm me-2"><i
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Tool\Datatable::resolve(['id' => 'feesTable','heads' => $heads ?? [],'config' => $config ?? [],'striped' => true,'hoverable' => true,'bordered' => true,'compressed' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="modal fade" id="waiveFeeModal" tabindex="-1" role="dialog" aria-labelledby="waiveFeeModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="waiveFeeForm" method="POST" action=""> 
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="adjustWaiverModal" tabindex="-1" role="dialog" aria-labelledby="adjustWaiverModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="adjustWaiverForm" method="POST" action=""> 
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
    ...
    <script>
        ...
        function formatCurrency(amount) {
            const formatter = new Intl.NumberFormat('en-US', { // Adjust locale as needed
                style: 'currency',
                currency: '<?php echo e(Qs::getSetting("currency_code", "TZS")); ?>', // Use system currency setting or fallback
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.open-waive-modal', function () {
                ...
                $('#waiveFeeForm').attr('action', "<?php echo e(url('staff/fees')); ?>/" + feeId + "/waive");
            ...
            $(document).on('click', '.open-adjust-waiver-modal', function () {
                ...
                $('#adjustWaiverForm').attr('action', "<?php echo e(url('staff/fees')); ?>/" + feeId + "/adjust-waiver");
            ...
            if (printButton) {
                printButton.addEventListener('click', function () {
                    const printUrlBase = "<?php echo e(route('staff.fees.print_filtered_names')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/giftscho/school-system/resources/views/pages/staff/fees/index.blade.php ENDPATH**/ ?>